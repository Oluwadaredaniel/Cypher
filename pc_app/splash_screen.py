...
class SplashScreen(ctk.CTkFrame):
    def __init__(self, parent, on_complete):
        ...
        letters = [("C", COLORS["white"]), ("Y", COLORS["accent"]),
                   ("P", COLORS["white"]), ("H", COLORS["white"]),
                   ("E", COLORS["white"]), ("R", COLORS["white"])]

        for ch, color in letters:
            lbl = ctk.CTkLabel(logo_row, text=ch,
    ...
    def _fade_out(self, step=10):
        if step >= 0:
            # Simulate fade by reducing visibility
